...
// console.log(Elephant);              // ✅ Shows only "own properties"
// console.log(Elephant.describe());   // ✅ Works, part of instance
// console.log(Elephant.sound());      // ✅ Works, from prototype

// console.log(Elephant.hasOwnProperty('describe'));   // true
// console.log(Elephant.hasOwnProperty('sound'));      // false

// console.log(Elephant.__proto__.hasOwnProperty('describe')); // false
// console.log(Elephant.__proto__.hasOwnProperty('sound'));    // true
